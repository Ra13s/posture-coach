    ...
    return (
        <div className="app-screen" style={{
            ...
            <div style={{
                ...
                {view === 'posture-routine' && <Wizard navigateTo={navigateTo} routineId="posture" />}
                {view === 'posture-strength' && <Wizard navigateTo={navigateTo} routineId="posture_strength" />}
