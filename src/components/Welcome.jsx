...
function Welcome({ navigateTo }) {
    ...
    // Posture manual link per language
    const workoutGuideUrl = language === 'et' 
        ? './posture_workout_et.html' 
        : './posture_workout.html';
    return (
        <div style={{ 
            display: 'flex',
            ...
            <div style={{ 
                ...
                <button 
                    onClick={() => navigateTo('posture-routine')} 
                    style={{ 
                        padding: '1.5rem 1rem', 
                ...
                <button 
                    onClick={() => navigateTo('posture-strength')} 
                    style={{ 
                        padding: '1.5rem 1rem', 
